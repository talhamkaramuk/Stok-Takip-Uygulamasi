        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestHash = table.Column<string>(type: "character varying(88)", maxLength: 88, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_products_critical_stock_non_negative", "\"CriticalStockLevel\" >= 0");
                    table.CheckConstraint("ck_products_current_stock_non_negative", "\"CurrentStock\" >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryCounts_ApplicationUsers_StartedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupplierName = table.Column<string>(type: "character varying(180)", maxLength: 180, nullable: false),
                    WarehouseId = table.Column<Guid>(type: "uuid", nullable: true),
                    Status = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: false),
                    Notes = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseRequests_ApplicationUsers_RequestedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesOrders_ApplicationUsers_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_stock_movements_new_quantity_non_negative", "\"NewQuantity\" >= 0");
                    table.CheckConstraint("ck_stock_movements_quantity_non_negative", "\"Quantity\" >= 0");
                    table.ForeignKey(
                        name: "FK_StockMovements_ApplicationUsers_PerformedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_inventory_count_items_counted_non_negative", "\"CountedQuantity\" >= 0");
                    table.CheckConstraint("ck_inventory_count_items_expected_non_negative", "\"ExpectedQuantity\" >= 0");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryCountItems_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_purchase_request_items_quantity_positive", "\"Quantity\" > 0");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchaseRequestItems_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ReturnRequests_SalesOrders_SalesOrderId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReturnRequests_Warehouses_WarehouseId",
                        column: x => x.WarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_sales_order_items_quantity_positive", "\"Quantity\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    ShipmentNumber = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    SalesOrderId = table.Column<Guid>(type: "uuid", nullable: true),
                    CustomerId = table.Column<Guid>(type: "uuid", nullable: true),
                    WarehouseId = table.Column<Guid>(type: "uuid", nullable: true),
                    RecipientName = table.Column<string>(type: "character varying(180)", maxLength: 180, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_return_request_items_quantity_positive", "\"Quantity\" > 0");
                    table.ForeignKey(
                        name: "FK_ReturnRequestItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReturnRequestItems_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_shipment_items_quantity_positive", "\"Quantity\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IdempotencyRecords_TenantId_OperationName_Key",
                table: "IdempotencyRecords",
                columns: new[] { "TenantId", "OperationName", "Key" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryCountItems_TenantId_InventoryCountId_ProductId",
                table: "InventoryCountItems",
                columns: new[] { "TenantId", "InventoryCountId", "ProductId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_InventoryCounts_StartedByUserId",
                table: "InventoryCounts",
                column: "StartedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryCounts_TenantId_Status",
                table: "InventoryCounts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseRequestItems_TenantId_PurchaseRequestId_ProductId",
                table: "PurchaseRequestItems",
                columns: new[] { "TenantId", "PurchaseRequestId", "ProductId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReturnRequestItems_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReturnRequestItems_TenantId_ReturnRequestId_ProductId",
                table: "ReturnRequestItems",
                columns: new[] { "TenantId", "ReturnRequestId", "ProductId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReturnRequests_SalesOrderId",
                table: "ReturnRequests",
                column: "SalesOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_ReturnRequests_TenantId_ReturnNumber",
                table: "ReturnRequests",
                columns: new[] { "TenantId", "ReturnNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ReturnRequests_TenantId_Status",
                table: "ReturnRequests",
                columns: new[] { "TenantId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesOrderItems_TenantId_SalesOrderId_ProductId",
                table: "SalesOrderItems",
                columns: new[] { "TenantId", "SalesOrderId", "ProductId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShipmentItems_TenantId_ShipmentId_ProductId",
                table: "ShipmentItems",
                columns: new[] { "TenantId", "ShipmentId", "ProductId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockMovements_TenantId_TransferGroupId",
                table: "StockMovements",
                columns: new[] { "TenantId", "TransferGroupId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseStocks_TenantId_ProductId",
                table: "WarehouseStocks",
                columns: new[] { "TenantId", "ProductId" });
